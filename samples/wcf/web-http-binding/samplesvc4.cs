...
public class Test
{
	...
	public static void Main ()
	{
		...
		se.Behaviors.Add (new WebHttpBehavior () { DefaultBodyStyle = WebMessageBodyStyle.WrappedResponse });
		host.Open ();
...
{
	[OperationContract]
	[WebGet (RequestFormat = WebMessageFormat.Json, ResponseFormat = WebMessageFormat.Json, BodyStyle = WebMessageBodyStyle.WrappedResponse)]
