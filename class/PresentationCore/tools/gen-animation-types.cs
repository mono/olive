...
{{
	public static readonly DependencyProperty ByProperty
				= DependencyProperty.Register (""By"", typeof ({1}?), typeof ({0}Animation));
	public static readonly DependencyProperty FromProperty
				= DependencyProperty.Register (""From"", typeof ({1}?), typeof ({0}Animation));
	public static readonly DependencyProperty ToProperty
				= DependencyProperty.Register (""To"", typeof ({1}?), typeof ({0}Animation));
