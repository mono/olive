...
4. In command prompt, in directory  Test\FeatureBased\Features.Client run "svcutil.exe <endpointbase>/<serverclassname> /n:*,Proxy.MonoTests.Features.Client" e.g.
   svcutil http://localhost:9999/ExitProcessHelperServer /n:*,Proxy.MonoTests.Features.Client
