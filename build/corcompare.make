API_INFO = $(MONO_PATH) $(RUNTIME) $(topdir)/status/mono-api-info.exe
API_DIFF = $(MONO_PATH) $(RUNTIME) $(topdir)/status/mono-api-diff.exe
TRANSFORM = $(MONO_PATH) $(RUNTIME) $(topdir)/status/transform.exe
